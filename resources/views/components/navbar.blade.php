<div class="navbar">
    ...
    <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap">Portal berita</span>
    </a>
    <div class="flex md:order-2">
        ...
        <input type="text" id="search-navbar" class="block w-full p-2 ps-10 text-sm text-white rounded-lg bg-emerald-700" placeholder="Search...">
        </div>
        ...
        <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
                <a href="#" class="block py-2 px-3 text-gray-900 rounded-sm" aria-current="page">Home</a>
            </li>
            <li>
                <a href="#" class="block py-2 px-3 text-gray-900 rounded-sm">About</a>
            </li>
            <li>
                <a href="#" class="block py-2 px-3 text-gray-900 rounded-sm">Services</a>
            </li>
        </ul>
        </div>
    </div>
